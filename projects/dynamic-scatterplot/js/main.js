...
var tip = d3.tip().attr('class', 'd3-tip').html( function(d) {
  ...
  text += "<strong>Popultation:</strong><span style='color:red'>" + d3.format(",.0f")(d.population) + "</span><br>"
...
console.log($(".selector").slider("value"))
...
function update(data) {
    ...
    const filteredData = data.filter(function(d, index) {
      if (continent === 'all') {
        return true
      } else {
    ...
    var circles = g.selectAll("circle").data(filteredData, function(d){
        return d.country;
    });
    ...
    $("#date-slider").slider("value", Number(time + 1))
}
